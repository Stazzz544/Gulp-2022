...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "inicialState": () => (/* binding */ inicialState),
...
/* harmony import */ var _modules_selectHeader_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/selectHeader.js */ "./\u0000#src/js/modules/selectHeader.js");
/* harmony import */ var _modules_changePage_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/changePage.js */ "./\u0000#src/js/modules/changePage.js");
...
/* harmony import */ var _modules_firebaseFunctions_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/firebaseFunctions.js */ "./\u0000#src/js/modules/firebaseFunctions.js");
...
(0,_modules_selectHeader_js__WEBPACK_IMPORTED_MODULE_1__.select)();
document.querySelector('header').onclick = _modules_changePage_js__WEBPACK_IMPORTED_MODULE_2__.changePage


firstStartApp();
(0,_modules_firebaseFunctions_js__WEBPACK_IMPORTED_MODULE_4__.tableOfnorms)('#normsTable'); //первый рендер таблицы норм выдачи
(0,_modules_firebaseFunctions_js__WEBPACK_IMPORTED_MODULE_4__.tableOfReceived)('#receivedTable');//первый рендер таблицы полученных вещей
...
document.querySelector('#editSelfCard').onclick = () => (0,_modules_firebaseFunctions_js__WEBPACK_IMPORTED_MODULE_4__.editOrDeleteBtn)('.modal-edit', editExistStaffCardAndReplaceItInFirebase);
//---------------------------------------------------
// Удаление карточки с сохранением результата в БД (красн. кнопка удалить)
document.querySelector('#delSelfCard').onclick = () => (0,_modules_firebaseFunctions_js__WEBPACK_IMPORTED_MODULE_4__.editOrDeleteBtn)('.modal-delete', _modules_firebaseFunctions_js__WEBPACK_IMPORTED_MODULE_4__.deleteExistStaffCard);
//---------------------------------------------------
// Показать карточку при клике на фамилию в списке
document.querySelector('#listOfstaff').onclick = _modules_firebaseFunctions_js__WEBPACK_IMPORTED_MODULE_4__.showCompliteCard;
//---------------------------------------------------
// сортировать список карточек по алфавиту
document.querySelector('.list__sort-alphabet').onclick = _modules_firebaseFunctions_js__WEBPACK_IMPORTED_MODULE_4__.showSortedStaffsOnPage;
//---------------------------------------------------
// сортировать список карточек по дате добавления
document.querySelector('.list__sort-data').onclick = _modules_firebaseFunctions_js__WEBPACK_IMPORTED_MODULE_4__.showStaffsOnPage;
//---------------------------------------------------
// Добавляет поле для ввода норм выдачи в карточке создания
document.querySelector('#addFieldsToNorms').onclick = () => (0,_modules_firebaseFunctions_js__WEBPACK_IMPORTED_MODULE_4__.tableOfnorms)('#normsTable');
//---------------------------------------------------
// Добавляет поле для ввода норм выдачи в карточке редактирования
document.querySelector('#addFieldsToNormsInEdit').onclick = () => (0,_modules_firebaseFunctions_js__WEBPACK_IMPORTED_MODULE_4__.tableOfnorms)('#getNormsTable');
//---------------------------------------------------
//Слушатели на все кнопки удаления строк в нормах выдачи(первый старт)
(0,_modules_firebaseFunctions_js__WEBPACK_IMPORTED_MODULE_4__.addListenerToArrOfElements)('.del-button-tableOfnorms', _modules_firebaseFunctions_js__WEBPACK_IMPORTED_MODULE_4__.delTargetNormTable);
//Слушатели на все кнопки удаления строк в таблице получения предметов(первый старт)
(0,_modules_firebaseFunctions_js__WEBPACK_IMPORTED_MODULE_4__.addListenerToArrOfElements)('.del-button-tableOfReceived', _modules_firebaseFunctions_js__WEBPACK_IMPORTED_MODULE_4__.delTargetReceivedTable);
//---------------------------------------------------
// Добавляет поле для ввода полученных вещей в карточке редактирования
document.querySelector('#addFieldsToReceived').onclick = () => (0,_modules_firebaseFunctions_js__WEBPACK_IMPORTED_MODULE_4__.tableOfReceived)('#receivedTable');
//---------------------------------------------------
// Добавляет поле для ввода полученных вещей в карточке редактирования
document.querySelector('#AddFieldsToReceivedInEdit').onclick = () => (0,_modules_firebaseFunctions_js__WEBPACK_IMPORTED_MODULE_4__.tableOfReceived)('#getReceivedTable');
//---------------------------------------------------
...
//Функция добавления новой карточки в базу данных
 async function addNewPersonCardToFirebase() {
	...
	(0,firebase_database__WEBPACK_IMPORTED_MODULE_5__.set)((0,firebase_database__WEBPACK_IMPORTED_MODULE_5__.ref)(db, `company/staff`), staff); //код добавления в базу данных нашего локального стэйта
	(0,_modules_firebaseFunctions_js__WEBPACK_IMPORTED_MODULE_4__.clearAllFieldsInForm)(allFields);// чистим поля формы
	(0,_modules_firebaseFunctions_js__WEBPACK_IMPORTED_MODULE_4__.deleteTable)('.created-norm-grid-container');//удаляем все таблицы норм выдачи
	(0,_modules_firebaseFunctions_js__WEBPACK_IMPORTED_MODULE_4__.deleteTable)('.self-card__received-grid-container-created')//удаляем все таблицы полученных вещей
	;(0,_modules_firebaseFunctions_js__WEBPACK_IMPORTED_MODULE_4__.tableOfnorms)('#normsTable');//создаём чистую новую строку таблицы норм выдачи
	getAllDataFromBase();// получаем всю дату из базы
	(0,_modules_firebaseFunctions_js__WEBPACK_IMPORTED_MODULE_4__.showStaffsOnPage)(); // выводим наш стафф на страницу в бар
}
...
//функция сохранения карточки после её редактирования.
 async function editExistStaffCardAndReplaceItInFirebase(){
	...
	const allField = (0,_modules_firebaseFunctions_js__WEBPACK_IMPORTED_MODULE_4__.getAllFieldFromEditCard)();
...
//изменяем поля в объекте рабочего
	...
	const staff = state.company.staff;
	(0,firebase_database__WEBPACK_IMPORTED_MODULE_5__.set)((0,firebase_database__WEBPACK_IMPORTED_MODULE_5__.ref)(db, `company/staff`), staff);
	(0,_modules_firebaseFunctions_js__WEBPACK_IMPORTED_MODULE_4__.showStaffsOnPage)();
}

 function getAllDataFromBase() { //получение данных из базы
	const dbref = (0,firebase_database__WEBPACK_IMPORTED_MODULE_5__.ref)(db);

	return (0,firebase_database__WEBPACK_IMPORTED_MODULE_5__.get)((0,firebase_database__WEBPACK_IMPORTED_MODULE_5__.child)(dbref, "/"))
	.then(data => {
		if (data.val() != null){ 
			state = data.val();
...
async function firstStartApp(){
	...
	;(0,_modules_firebaseFunctions_js__WEBPACK_IMPORTED_MODULE_4__.showStaffsOnPage)()// синхронная функция, выполнить после асинхронной
}
...
/***/ "./\u0000#src/js/modules/firebaseFunctions.js":
/*!***********************************************!*\
  !*** ./ #src/js/modules/firebaseFunctions.js ***!
  \***********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "addListenerToArrOfElements": () => (/* binding */ addListenerToArrOfElements),
/* harmony export */   "getAllFieldFromNewCard": () => (/* binding */ getAllFieldFromNewCard),
/* harmony export */   "getAllFieldFromEditCard": () => (/* binding */ getAllFieldFromEditCard),
/* harmony export */   "showCompliteCard": () => (/* binding */ showCompliteCard),
/* harmony export */   "addNewPersonCardToFirebase": () => (/* binding */ addNewPersonCardToFirebase),
/* harmony export */   "editExistStaffCardAndReplaceItInFirebase": () => (/* binding */ editExistStaffCardAndReplaceItInFirebase),
/* harmony export */   "clearAllFieldsInForm": () => (/* binding */ clearAllFieldsInForm),
/* harmony export */   "editOrDeleteBtn": () => (/* binding */ editOrDeleteBtn),
/* harmony export */   "getAllDataFromBase": () => (/* binding */ getAllDataFromBase),
/* harmony export */   "showStaffsOnPage": () => (/* binding */ showStaffsOnPage),
/* harmony export */   "showSortedStaffsOnPage": () => (/* binding */ showSortedStaffsOnPage),
/* harmony export */   "deleteExistStaffCard": () => (/* binding */ deleteExistStaffCard),
/* harmony export */   "tableOfnorms": () => (/* binding */ tableOfnorms),
/* harmony export */   "tableOfReceived": () => (/* binding */ tableOfReceived),
/* harmony export */   "getDataFromTableOffReceived": () => (/* binding */ getDataFromTableOffReceived),
/* harmony export */   "getDataFromTableOfnorms": () => (/* binding */ getDataFromTableOfnorms),
/* harmony export */   "deleteTable": () => (/* binding */ deleteTable),
/* harmony export */   "renderOfReceivedTable": () => (/* binding */ renderOfReceivedTable),
/* harmony export */   "renderOfNormsTable": () => (/* binding */ renderOfNormsTable),
/* harmony export */   "delTargetNormTable": () => (/* binding */ delTargetNormTable),
/* harmony export */   "delTargetReceivedTable": () => (/* binding */ delTargetReceivedTable),
/* harmony export */   "firstStartApp": () => (/* binding */ firstStartApp)
/* harmony export */ });
...
function showCompliteCard(e) {
	...
	if (target.classList.contains('list__items')) {
		...
		const wishCard = _app_js__WEBPACK_IMPORTED_MODULE_0__.state.company.staff.find(e => e.id == parentId);
...
async function addNewPersonCardToFirebase() {
	...
	const staff = _app_js__WEBPACK_IMPORTED_MODULE_0__.state.company.staff;
	staff.push(newWorker); //пушим в локальный стэйт

	(0,firebase_database__WEBPACK_IMPORTED_MODULE_2__.set)((0,firebase_database__WEBPACK_IMPORTED_MODULE_2__.ref)(_app_js__WEBPACK_IMPORTED_MODULE_0__.db, `company/staff`), staff); //код добавления в базу данных нашего локального стэйта
...
//изменяем поля в объекте рабочего
	...
	const staff = state.company.staff;
	(0,firebase_database__WEBPACK_IMPORTED_MODULE_2__.set)((0,firebase_database__WEBPACK_IMPORTED_MODULE_2__.ref)(_app_js__WEBPACK_IMPORTED_MODULE_0__.db, `company/staff`), staff);
	showStaffsOnPage();
}
...
function getAllDataFromBase() { //получение данных из базы
	const dbref = (0,firebase_database__WEBPACK_IMPORTED_MODULE_2__.ref)(_app_js__WEBPACK_IMPORTED_MODULE_0__.db);

	return (0,firebase_database__WEBPACK_IMPORTED_MODULE_2__.get)((0,firebase_database__WEBPACK_IMPORTED_MODULE_2__.child)(dbref, "/"))
	.then(data => {
		if (data.val() != null){ 
			_app_js__WEBPACK_IMPORTED_MODULE_0__.state = data.val();
			_app_js__WEBPACK_IMPORTED_MODULE_0__.state.company.staff = _app_js__WEBPACK_IMPORTED_MODULE_0__.state.company.staff.filter((e) => e != null)
			return _app_js__WEBPACK_IMPORTED_MODULE_0__.state
		} else {return _app_js__WEBPACK_IMPORTED_MODULE_0__.inicialState;} //если данных нет - присваеваем каркас из store
	})
}
...
function showSortedStaffsOnPage() {
	const out = document.querySelector('.list__out');
	out.innerHTML = '';
	const json = JSON.stringify(_app_js__WEBPACK_IMPORTED_MODULE_0__.state.company.staff);
...
function deleteExistStaffCard(){
	const parentElement = document.querySelector('#getEmployeeInfo');
	const parentId = parentElement.getAttribute('employee-id');//получили id карточки
	const allEmployees = _app_js__WEBPACK_IMPORTED_MODULE_0__.state.company.staff;

	//фильтруем state, удаоляем оттуда карточку
	const newStaffList = allEmployees.filter(e => e.id != parentId);
	_app_js__WEBPACK_IMPORTED_MODULE_0__.state.company.staff = newStaffList;//заменяем поля в state
	(0,firebase_database__WEBPACK_IMPORTED_MODULE_2__.set)((0,firebase_database__WEBPACK_IMPORTED_MODULE_2__.ref)(_app_js__WEBPACK_IMPORTED_MODULE_0__.db, `company/staff`), newStaffList);//отправляем в базу новый state
...
function delTargetNormTable(e){
	...
	if (idCardOfEmployeeId) {
		const anyCard = _app_js__WEBPACK_IMPORTED_MODULE_0__.state.company.staff; //все карточки из state
...
function delTargetReceivedTable(e){
	...
	const idCardOfEmployeeId = targetBtn.closest('.main-content__page').getAttribute('employee-id');
	if (idCardOfEmployeeId) {
		const anyCard = _app_js__WEBPACK_IMPORTED_MODULE_0__.state.company.staff;
		anyCard.forEach(elem => {if (elem.id == idCardOfEmployeeId) targetCard = elem;})
...
async function firstStartApp(){
	_app_js__WEBPACK_IMPORTED_MODULE_0__.state = await getAllDataFromBase()// асинхронная функция
...
/***/ "./\u0000#src/js/modules/selectHeader.js":
/*!******************************************!*\
  !*** ./ #src/js/modules/selectHeader.js ***!
  \******************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
